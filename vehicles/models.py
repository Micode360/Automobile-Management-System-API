...
class Vehicle_Model(models.Model):
    # many to one relationship oneToOneField is only saying there is relationship between just one model data to another one model data another can't be created.
